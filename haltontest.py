...
def plot_voronois(pts1, pts2, iteration):
    ...
    plt.savefig("Halton_Test/Halton_Test_" + iteration + ".png")
    ax1.cla()
    ax2.cla()
    return
...
for i in range(5):
    ...
    plt.plot(dists1, 'r')
    plt.plot(dists2, 'b')
    plt.title('Red: Halton ; Blue: Monte Carlo')
    plt.savefig('Halton_Test/Halton_Test_Distance_' + str(i) + '.png')
